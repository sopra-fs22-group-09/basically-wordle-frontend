    ...
    >
      {lobbyInfo.name ? (
        <>
          ...
          <Box sx={{ width: '66%!important', float: 'left', border: 'solid 2px white' }}>
                  ...
                  {Object.values(GameMode).map((mode) => {
                    return (
                      <MenuItem
                        key={mode}
                        value={mode}
                        disabled={lobbyInfo.gameCategory != GameCategorization.get(mode)}
                      >
                        {mode}
                      </MenuItem>
                    );
            ...
            >
              ...
              <Button
                ...
                sx={{ mx: 2, mt: 2 }}
                disabled={
                  localStorage.getItem('userId') != lobbyInfo.ownerId ||
          ...
          <Box
            sx={{ float: 'right', width: '33%!important', height: 'calc(100vh - 200px)', border: 'solid 2px white' }}
          >
            chat
          </Box>
        </>
